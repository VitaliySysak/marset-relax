...
export const Hero: React.FC<Props> = ({ className }) => {
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row items-center justify-center mb-8 md:mb-16 mt-8 md:mt-0">
        <div className="flex flex-col gap-16 mt-8">
          <h1 className="w-full px-2 sm:px-0 text-[32px] lg:text-[42px] xl:text-[42px] 2xl:text-[60px] font-semibold">
            ...
            <span className="inline-block translate-y-[4px]">
              <ContainerTextFlip className="font-bold" interval={50000000} words={heroWords} />
            </span>
          </h1>
      ...
      <aside className="hidden md:flex h-fit flex-col justify-center relative">
        ...
        <img
          className="w-[clamp(300px,40vw,360px)] lg:w-[400px] xl:w-[clamp(400px,30vw,500px)] 2xl:w-[500px] rounded-t-[124px] xl:rounded-t-[150px] 2xl:rounded-t-[164px]"
          src={heroUrl}
          alt="hero"
        />
      </aside>
