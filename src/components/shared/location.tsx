  ...
  return (
    <section id="location" className={cn('flex flex-col-reverse lg:flex-row justify-center md:pt-20', className)}>
      ...
      <div className="flex flex-col px-12 justify-evenly gap-4 mb-16 text-center">
        <div>
          <h3 className="text-[48px] font-semibold font-title">Адреса</h3>
          <p>
            м.Львів <br /> Окуневського, 3
          </p>
        </div>
        <div>
          <h3 className="text-[48px] font-semibold font-title">Номер</h3>
          <p>+380965181114</p>
        </div>
        <div>
          <h3 className="text-[48px] font-semibold font-title">Пошта</h3>
          <p>
