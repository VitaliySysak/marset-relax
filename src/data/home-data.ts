...
export const heroDescription =
  'Пропонуємо класичний, антистресовий, глибокотканинний і спортивний масаж' +
  '— з індивідуальним підходом докожного клієнта. Ми використовуємо якісні натуральні олії';
...
export const testemonials = [
  {
    ...
    quote:
      'Скільки живу на світі, а живу я вже довго. На своєму віці мені не раз робили масаж. Інколи після масажу мені становилось гірше, бо люди, які роблять масаж, беруться за все, не звертаючи увагу на прохання клієнта. Знайома порекомендувала пана Ігора, бо була велика проблема з ногами. За 10 масажів проблеми не стало. І я дуже вдячна пану Ігорю за його відношення до людей. Він професійно і кваліфіковано робить масаж, а ще підтримав мене емоційно. Масаж допоміг. З повагою Бондарчук Алла.',
    mark: 5,
  },
  {
    name: 'Люба',
    ...
    quote:
      'Мені  син подарував  Сертифікат  на 10 масажів у п. Ігоря. Я навіть не очікувала. яким  гарним  буде результат.!  Після курсу масажів мене перестали боліти руки. Я змогла знову ліпити  чоловіку вареники.  В ногах  відчула надзвичайну  легкість, наче на крилах.   Впевнена,  після  масажних  процедур у п.Ігоря  своє  тіло відчуваєш   молодо і бадьоро. Усім рекомендую.',
    mark: 5,
  },
  {
    name: 'Алла',
    ...
    quote:
      "Я довго шукала масажиста, який поєднує професіоналізм і чуйне ставлення — і нарешті знайшла! Після кількох сеансів відчутно зменшився біль у шиї та спині, з'явилась легкість у тілі. Атмосфера спокійна, приємна музика, теплий прийом — усе сприяє розслабленню. Дуже вдячна, рекомендую всім знайомим!",
    mark: 5,
  },
  {
    name: 'Тетяна',
